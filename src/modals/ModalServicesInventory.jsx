...
const ModalServices = (props) => {
  ...
  const handelItemSelect = async (article) => {
    console.log(article);
    setSelected(article);
  };
                  ...
                  <div className="row d-flex justify-content-between mt-5 gy-5">
                    {type === "articles" &&
                      articlesSearchItems.map((el, i) => (
                        <div
                          className={`col-sm-2 item-card d-flex flex-column align-items-center pt-5  ${
                    ...
                    {type === "services" &&
                      servicesSearchItems.map((el, i) => (
                        ...
                        >
                          ...
                          />
                          <h1 className="item-name mb-2">
                            {el.service_id.category}
                          </h1>
                          <h2 className="item-subheading mb-2">
                            {el.service_id.name}
                          </h2>
                          <p>{el.service_id.price || 0}h</p>
                        </div>
                      ))}
                    {/* <div
                      id="1"
